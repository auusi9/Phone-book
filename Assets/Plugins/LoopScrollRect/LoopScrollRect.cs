...
namespace UnityEngine.UI
{
    ...
    {
        //==========LoopScrollRect==========
        [Tooltip("Prefab Source")] [SerializeField]
        private LoopScrollPrefabSource _prefabSource;

        public virtual LoopScrollPrefabSource prefabSource
        {
            get { return _prefabSource; }
        }
        ...
        public void ClearCells()
        {
            if (Application.isPlaying)
            {
                ...
                {
                    ReturnObject(content.GetChild(i));
                }
            }
        }

        protected virtual void ReturnObject(Transform transform)
        {
            prefabSource.ReturnObject(transform);
        }
        ...
        protected virtual void ProvideData(Transform transform, int idx)
        {
            dataSource.ProvideData(transform, idx);
        }
